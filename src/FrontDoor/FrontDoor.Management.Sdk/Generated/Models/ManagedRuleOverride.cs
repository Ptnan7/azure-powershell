...
namespace Microsoft.Azure.Management.FrontDoor.Models
{
    ...
    public partial class ManagedRuleOverride
    {
        ...
        /// </param>
        public ManagedRuleOverride(string ruleId, string enabledState = default(string), string action = default(string), string sensitivity = default(string), System.Collections.Generic.IList<ManagedRuleExclusion> exclusions = default(System.Collections.Generic.IList<ManagedRuleExclusion>))
